...
CylinderDlg::CylinderDlg(QWidget *parent)
	: QWidget(parent)
{
	ui.setupUi(this);
}
...
//确认
void CylinderDlg::on_btn_ok_clicked()
{
	bool ok;
	//获取lineedit数据
	...
	emit RANSAC(5, LocalPoint_d, Iteration_i, 0, Confidence_d, KdTreeSearhNum_i, ModelOPTI, NormalWeight_d, ifReverse, MinR_d, MaxR_d);
}

//取消
void CylinderDlg::on_btn_cancel_clicked()
{
	close();
}
