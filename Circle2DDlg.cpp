...
Circle2DDlg::Circle2DDlg(QWidget *parent)
	: QWidget(parent)
{
	ui.setupUi(this);
}

Circle2DDlg::~Circle2DDlg()
{}

//确认
void Circle2DDlg::on_btn_ok_clicked()
{
	bool ok;
	//获取lineedit数据
	...
	emit RANSAC(2, LocalPoint_d, Iteration_i, 0, Confidence_d, KdTreeSearhNum_i, ModelOPTI, NormalWeight_d, ifReverse, MinR_d, MaxR_d);
}

//取消
void Circle2DDlg::on_btn_cancel_clicked()
{
	close();
}
